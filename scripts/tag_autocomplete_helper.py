...
def on_ui_settings():
    ...
    # Main tag file
    shared.opts.add_option("tac_tagFile", shared.OptionInfo("danbooru_zh_cn.csv", "Tag filename", gr.Dropdown, lambda: {"choices": csv_files_withnone}, refresh=update_tag_files, section=TAC_SECTION))
    # Active in settings
